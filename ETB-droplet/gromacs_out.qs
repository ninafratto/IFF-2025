...
#$GROMACS_EXE grompp -f minim.mdp -c em.gro -r em.gro -p topol.top -o em0.tpr
#$GROMACS_EXE mdrun -deffnm em0

#$GROMACS_EXE grompp -f minim1.mdp -c em0.gro -r em0.gro -p topol.top -o em.tpr
#$GROMACS_EXE mdrun -deffnm em

#$GROMACS_EXE grompp -f nvt0.mdp -c em.gro -p topol.top -o nvt_01.tpr
#$GROMACS_EXE mdrun -nt 10 -deffnm nvt_01

#$GROMACS_EXE mdrun -nt 5 -cpi nvt_01 -deffnm nvt_01 -append

#$GROMACS_EXE insert-molecules -f napss.gro -ci TW.gro -radius 0.11 -nmol 265634 -o s.gro

#$GROMACS_EXE grompp -f minim.mdp -c em.gro -p topol.top -o em.tpr
#$GROMACS_EXE mdrun -nt 2 -deffnm em

#$GROMACS_EXE grompp -f minim.mdp -c em.gro -p topol.top -o em1.tpr
#$GROMACS_EXE mdrun -nt 2 -deffnm em1

#
#$GROMACS_EXE grompp -f npt0.mdp -c nvt_3.gro -p topol.top -o npt_0.tpr
#$GROMACS_EXE mdrun -nt 12 -deffnm npt_0

#$GROMACS_EXE grompp -f npt0.mdp -c npt_0.gro -p topol.top -o npt_1.tpr
#$GROMACS_EXE mdrun -nt 12 -deffnm npt_1



#$GROMACS_EXE mdrun -nt 11 -cpi npt_2 -deffnm npt_2 -append
#

##################################
## NINA'S AREA OF RUNNING STUFF ##
##################################

#$GROMACS_EXE grompp -f nvt.mdp -c em.gro -r em.gro -p topol.top -o nvt1.tpr
#$GROMACS_EXE mdrun -deffnm nvt1

#$GROMACS_EXE grompp -f nvt.mdp -c nvt1.gro -r em.gro -p topol.top -o nvt2.tpr
#$GROMACS_EXE mdrun -deffnm nvt2

#$GROMACS_EXE grompp -f nvt.mdp -c nvt2.gro -r em.gro -p topol.top -o nvt3.tpr
#$GROMACS_EXE mdrun -deffnm nvt3

#$GROMACS_EXE grompp -f nvt.mdp -c nvt3.gro -r em.gro -p topol.top -o nvt4.tpr
#$GROMACS_EXE mdrun -deffnm nvt4

#$GROMACS_EXE grompp -f out.mdp -c nvt4.gro -r nvt4.gro -p topol.top -o out.tpr
#$GROMACS_EXE mdrun -deffnm out
$GROMACS_EXE mdrun -deffnm out -cpi out.cpt -append

#####################
## END NINA'S AREA ##
#####################

#$GROMACS_EXE grompp -f npt.mdp -c npt_2.gro -p topol.top -o npt_3.tpr
#$GROMACS_EXE mdrun -nt 12 -deffnm npt_3

#$GROMACS_EXE grompp -f npt1.mdp -c npt_3.gro -p topol.top -o npt_4.tpr
#$GROMACS_EXE mdrun -nt 14 -deffnm npt_4

#$GROMACS_EXE mdrun -cpi nvt_3 -deffnm nvt_3 -append

#$GROMACS_EXE grompp -f npt0.mdp -c nvt_4.gro -p topol.top -o npt_0.tpr
#$GROMACS_EXE mdrun -nt 10 -deffnm npt_0

#$GROMACS_EXE mdrun -cpi nvt2 -deffnm nvt2 -append

#$GROMACS_EXE mdrun -cpi nvt1 -deffnm nvt1 -append
